(ns org.altlaw.www.server
  ...
  (:require [org.altlaw.util.context :as context]
            ...
            org.altlaw.rest.status_service_dev
            org.altlaw.rest.status_service_public))
...
(defn -main [& args]
  (let [app (new org.altlaw.www.application)
    ...
    (if (= (context/altlaw-env) "production")
      (.setStatusService app (new org.altlaw.rest.status_service_public))
      (.setStatusService app (new org.altlaw.rest.status_service_dev)))
